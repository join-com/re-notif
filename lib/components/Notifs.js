...
var Notifs = function Notifs(props) {
  ...
  var notificationsWithRefs = _react2.default.useMemo(function () {
    return notifications.map(function (notification) {
      return {
        notification: notification,
        ref: _react2.default.createRef(null)
      };
    });
  }, [notifications]);

  var renderedNotifications = notificationsWithRefs.map(function (_ref, i) {
